...
int get_shared_memory(key_t key, const char *name);//function to get memory id
...
void clean_shared_memory(int key, const char*); //function for cleaning the shared memory
